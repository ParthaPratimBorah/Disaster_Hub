...
// --- SVG THUMBNAILS ---
export const FloodSVG = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 60" {...props}>
        <path d="M0 60 L100 60 L100 40 C 80 55, 60 25, 40 40 C 20 55, 10 30, 0 40 Z" fill="#8AAEE0" />
        <path d="M0 60 L100 60 L100 50 C 85 60, 65 40, 45 50 C 25 60, 15 45, 0 50 Z" fill="#628ECB" opacity="0.7" />
        <rect x="65" y="25" width="20" height="15" fill="#395886" />
        <polygon points="63,25 87,25 75,18" fill="#628ECB" />
    </svg>
);
export const CycloneSVG = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 60" {...props}>
        <path d="M 50 30 C 60 10, 90 10, 90 30 C 110 30, 110 60, 90 60 C 70 80, 40 80, 40 60 C 20 60, 20 30, 40 30 C 30 15, 40 15, 50 30 Z" fill="none" stroke="#8AAEE0" strokeWidth="3" strokeLinecap="round">
            <animateTransform attributeName="transform" type="rotate" from="0 50 30" to="360 50 30" dur="5s" repeatCount="indefinite" />
        </path>
        <path d="M 50 30 C 55 20, 70 20, 70 30 C 80 30, 80 45, 70 45 C 60 55, 45 55, 45 45 C 35 45, 35 30, 45 30 C 42 25, 45 25, 50 30 Z" fill="none" stroke="#628ECB" strokeWidth="2" strokeLinecap="round">
            <animateTransform attributeName="transform" type="rotate" from="360 50 30" to="0 50 30" dur="3s" repeatCount="indefinite" />
        </path>
    </svg>
);
export const EarthquakeSVG = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 60" {...props}>
        <path d="M0 60 L100 60 L100 50 L 80 50 L 75 55 L 60 55 L 55 50 L 40 50 L 35 55 L 20 55 L 15 50 L0 50 Z" fill="#628ECB" />
        <path d="M 20 50 L 20 30 L 40 30 L 40 50" fill="#395886" transform="rotate(-5 30 50)" />
        <path d="M 55 50 L 55 20 L 80 20 L 80 50" fill="#8AAEE0" transform="rotate(5 67.5 50)"/>
    </svg>
);
export const FireSVG = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 60" {...props}>
