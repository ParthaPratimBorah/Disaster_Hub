...
import { user, drills, badges } from '../../constants';
import { useAppContext } from '../../contexts/AppContext';

// Import the game overlay
import GameOverlay from '../../components/gameoverlay/gameoverlay.tsx';
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <p className="text-sm mb-4" style={{ color: PALETTE.text_secondary }}>
                    Earthquake Survival Visual Novel
                </p>
                <button 
            ...
            {/* Game overlay (conditionally rendered) */}
