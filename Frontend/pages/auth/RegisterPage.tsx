...
import { ShieldIcon, ProfileIcon, UserIcon, LockIcon } from '../../constants';
...
const RegisterPage: React.FC<RegisterPageProps> = ({ setAuthPage }) => {
    const { setIsAuthenticated, PALETTE } = useAppContext();
    return (
        <div className="flex flex-col items-center text-center">
            ...
            <div className="w-full space-y-4">
                <AuthInput icon={ProfileIcon} placeholder="Full Name" type="text" />
